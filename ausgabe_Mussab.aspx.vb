...
Partial Class [ausgabe]
    ...
    Private Sub ausgabe_Load(sender As Object, e As EventArgs) Handles Me.Load
        Dim platz1, platz2, platz3, platz4, platz5, platz6 As Integer
        Dim x1, x2, x3, x4, x5, x6 As Integer
        x1 = 0 'votings("Hockenheim")
        x2 = 0 'votings("Nuerburgring")
        x3 = 12 'votings("Sachsenring")
        x4 = 41 'votings("Bilster_Berg")
        x5 = 21 'votings("Oschersleben")
        x6 = 21 'votings("Lausitzring")
        ...
        For a = 0 To numbers.Length - 1
            Response.Write(numbers(a).ToString + "<br />")
